...
class OgretmenWithSinifSchema(OgretmenSchema):
    sinifi: Optional[list['SinifSchema']] = None
...
class VeliWithOgrenciSchema(VeliSchema):
    ogrenciler: list['OgrenciSchema'] | Field(default_factory=list)  # normalde bu kısımlar | None = [] şeklindeydi fakat hata aldığımdan böyle yaptım sorulacak!
